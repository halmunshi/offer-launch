    ...
    *,
    ...
    await db.execute(
        ...
        ),
        {
            ...
            "funnel_type": intake_data.get("funnel_type", "call_funnel"),
            "theme": intake_data.get("funnel_style", "high_converting"),
        },
    )
...
def build_test_state(
    *,
    ...
    return {
        ...
        "funnel_id": funnel_id,
        "job_id": str(uuid4()),
        "copywriter_job_id": str(uuid4()),
        "workflow_type": "funnel_only",
        "active_agents": ["copywriter", "funnel_builder"],
        "offer_intake": intake,
        "offer_industry": "business coaching",
        "funnel_name": "Six Figure Coach Academy Funnel",
        "funnel_type": "call_funnel",
        "funnel_style": "high_converting",
        "funnel_integrations": {
            "has_vsl": True,
            "vsl_embed": "User will provide embed link later. Use a placeholder for now.",
            "calendar_provider": "calendly",
            "calendar_embed": "User will provide embed link later. Use a placeholder for now.",
            "selected_pages": ["vsl", "booking", "confirmation"],
        },
        "selected_pages": ["vsl", "booking", "confirmation"],
        "connected_platforms": {},
